...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "grid grid-cols-7 gap-2 text-center text-[var(--vscode-foreground)] min-h-0 overflow-hidden",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-muted-foreground text-sm border outline-inherit mt-4 p-2 h-full min-h-0 overflow-hidden",
        className
      )}
      {...props}
    />
